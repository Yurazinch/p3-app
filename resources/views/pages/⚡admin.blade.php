        ...
        <section class="dashboard__wrapper">
            ...
            <div class="admin-section__segment">
                ...
                <div class="admin-tables">
                    <div class="admin-tables__head-wrapper tables-overflow">
                        ...
                        <div class="admin-tables__head cell-name">Название</div>
                        <div class="admin-tables__head cell-complexity">Сложность</div>
                        <div class="admin-tables__head cell-edition">Изменить</div>
                    </div>
                    <ul class="admin-tables__lists width-160">                        
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Выпускная квалификационная работа (дипломная работа)</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                        ...
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Магистерская диссертация</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        ...
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Научная работа</div>
                                <div class="admin-tables__list-cell cell-complexity">Средняя</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Курсовая работа</div>
                                <div class="admin-tables__list-cell cell-complexity">Средняя</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        ...
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Реферат</div>
                                <div class="admin-tables__list-cell cell-complexity">Средняя</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        ...
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Статья РИНЦ</div>
                                <div class="admin-tables__list-cell cell-complexity">Низкая</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Статья ВАК</div>
                                <div class="admin-tables__list-cell cell-complexity">Низкая</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
                        ...
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-name">Отчет по практике</div>
                                <div class="admin-tables__list-cell cell-complexity">Низкая</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>
            ...
            <div class="admin-section__segment">
                ...
                <div class="admin-tables">
                    <div class="admin-tables__head-wrapper tables-overflow">
                        <div class="admin-tables__head cell-id">ID</div>
                        <div class="admin-tables__head cell-term">Срок исполнения</div>
                        <div class="admin-tables__head cell-complexity">Сложность</div>
                        <div class="admin-tables__head cell-correction">Коэффициент</div>
                        <div class="admin-tables__head cell-edition">Изменить</div>
                    </div>
                    <ul class="admin-tables__lists width-240">
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">1 месяц</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">1</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">3 недели</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">1,25</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">2 недели</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">1,5</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">1 неделя</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">1,75</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">До 6 дней</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">2</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
                        <li class="admin-tables__list">
                            <div class="admin-tables__list-wrapper">
                                <div class="admin-tables__list-cell cell-id">ID</div>
                                <div class="admin-tables__list-cell cell-term">1 день</div>
                                <div class="admin-tables__list-cell cell-complexity">Высокая</div>
                                <div class="admin-tables__list-cell cell-correction">2,5</div>
                                <div class="admin-tables__list-cell cell-edit"><button class="cell-button"><img src="{{ asset('storage/img/pen_edit_icon.webp') }}" alt=""></button></div>
                                <div class="admin-tables__list-cell cell-delete"><button class="cell-button"><img src="{{ asset('storage/img/basket_trash_icon.webp') }}" alt=""></button></div>
                            </div>                            
                        </li>
